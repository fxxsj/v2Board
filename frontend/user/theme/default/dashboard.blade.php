...
<head>
    ...
    <link rel="modulepreload" href="/theme/{{$theme}}/assets/vendors.async.js?v={{$version}}">
    <link rel="modulepreload" href="/theme/{{$theme}}/assets/components.async.js?v={{$version}}">
...
<script type="module" src="/theme/{{$theme}}/assets/umi.js?v={{$version}}"></script>
